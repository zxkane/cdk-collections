 ...
 *   "id": "01234567890123456789012345678901234567890123456789012345",
 *   "timestamp": 1510109208016,
 *   "message": "1572794974900776,aurorainstance1,master,10.0.1.102,4513,528724,QUERY,sys,'select sys_version,mysql_version from version',0"
 * }
 *
...
function transformLogEvent(logEvent) {
    return csv({
        noheader:true,
        quote: '\'',
        headers: ['timestamp', 'instanceid', 'user', 'sourceip', 'connectionid', 'queryid', 'operation', 'database', 'sqltext', 'retcode']
    }).fromString(logEvent.message).then(function(jsonArray){
        jsonArray[0].timestamp = jsonArray[0].timestamp / (1000*1000);
